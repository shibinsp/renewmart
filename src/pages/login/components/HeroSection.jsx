  ...
  return (
    <div className="h-full flex flex-col justify-between p-8 lg:p-12">
      ...
      <div className="flex items-center space-x-3 mb-8">
        ...
        <div>
          <h2 className="text-2xl font-bold text-white">RenewMart</h2>
          <p className="text-green-100 text-sm">Renewable Energy Marketplace</p>
        </div>
      </div>
      {/* Hero Content */}
      <div className="flex-1 flex flex-col justify-center">
        ...
        <div className="space-y-4 mb-8">
          <div className="flex items-center space-x-3">
            ...
            <span className="text-green-100">Enterprise-grade security and compliance</span>
          </div>
          <div className="flex items-center space-x-3">
            <div className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
              <Icon name="Users" size={16} color="white" />
            </div>
            <span className="text-green-100">Multi-stakeholder collaboration platform</span>
          </div>
          <div className="flex items-center space-x-3">
            <div className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
              <Icon name="BarChart3" size={16} color="white" />
            </div>
            <span className="text-green-100">Real-time analytics and reporting</span>
          </div>
          <div className="flex items-center space-x-3">
            <div className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
              <Icon name="FileText" size={16} color="white" />
            </div>
            <span className="text-green-100">End-to-end project lifecycle management</span>
          </div>
        </div>
      </div>
      {/* Trust Signals */}
      <div className="mt-8">
        <p className="text-green-100 text-sm mb-4 text-center">Trusted by industry leaders</p>
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {trustSignals?.map((signal, index) => (
            ...
            >
              ...
              <div className="text-green-100 text-xs mt-1">Certified</div>
            </div>
          ))}
        </div>
      </div>
